...
1. Install software: Python interpreter and VS Code.
2. Setup VS Code.
3. Learn how to print data in Terminal
4. Learn how to enter data in Terminal
5. Learn variables.
6. Learn how to merge strings.
7. Learn how to do Math in Python.
8. Learn Conditional Statements.
9. Learn Functions.
10. Learn the While Loop.

You are going to learn it by doing. Together, we're going to create a simple calculator and improve it with each step above. 

Here are some tips on how to go through tutorial:
...
5. In the editor type the text below 
6. Click to the Run Python File button on the right top corner.
7. The result will be in the bottom part of VS Code - this is **Terminal**.
...
Let's use a variable in our first 'hello world' program, for now we simply give it the name "variable".
```python
...
### Step 6: Learn how to merge strings
...
- You create a function in one part of code like this:
  ```python
    def function_name():
        # execute some code here.
  ``` 
- To execute the function, place its name in another part of code and add parenthesis like this `function_name()`
- Your function can take some input and produce some output. 

Let's now create a simple function which takes two strings, merges them and then prints output:

```python
def print_to_strings(string1, string2):
    merged_string = string1 + string2
    print(merged_string)
```

If you will try to execute just this code nothing is going to happen. That is because we need separate statement to execute it:
```python
